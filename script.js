...
// Inicializar quando o DOM estiver pronto para evitar getElementById retornando null
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (formInscricao) {
        formInscricao.addEventListener('submit', (e) => {
            ...
            const formData = {
                nomeInstituicao: document.getElementById('nomeInstituicao') ? document.getElementById('nomeInstituicao').value : '',
                ...
                tipoInstituicao: document.getElementById('tipoInstituicao') ? document.getElementById('tipoInstituicao').value : '',
                numeroAlunos: document.getElementById('numeroAlunos') ? document.getElementById('numeroAlunos').value : '',
                nomeResponsavel: document.getElementById('nomeResponsavel') ? document.getElementById('nomeResponsavel').value : '',
                cargoResponsavel: document.getElementById('cargoResponsavel') ? document.getElementById('cargoResponsavel').value : '',
            ...
            if (cnpjLimpo.length > 0 && !validaCNPJ(cnpjLimpo)) {
                ...
                if (cnpjInput) { cnpjInput.focus(); cnpjInput.style.borderColor = '#ef4444'; }
                return;
            }
